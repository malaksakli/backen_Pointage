...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public ResponseEntity<?> ajoutEmployee(Employee employee) {
        if (repemp.existsById(employee.getMatr())) {
            return ResponseEntity.badRequest().body("Employee with this matricule already exists!");
        }

        Employee savedEmployee = repemp.save(employee);
    ...
    public List<Employee> getallavecpointage() {
        return repemp.findAllWithPointages();
    }
    ...
    @Override
    public List<Employee> rechercheparnom(String nom) {
        return repemp.findEmployeesByNomEtPrenom(nom);
    }
    ...
    public void modifierEmployee(Long matr, Employee updatedEmployee) {
        ...
        existingEmployee.setCnss(updatedEmployee.getCnss());
    ...
    @Override
    public boolean existsByMatr( Long matr) {
        return repemp.existsByMatr(matr);
    }
